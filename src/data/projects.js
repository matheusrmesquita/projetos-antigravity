...
export const projects = [
    ...
    },
    {
        ...
        context_en: "The first goal of this project was to develop an institutional landing page to present the Vesali Community clearly and strategically. The page was structured to highlight the main challenges faced by the target audience, demonstrate how the community can solve these pain points, and showcase its benefits and mentors. Furthermore, the user experience was designed to intuitively guide users to the main action: joining the exclusive WhatsApp group.",
        ...
        highlight_en: "Develop a form-based tool to diagnose user knowledge in the main areas where the community offers support. Diagnostic data is defined by information provided by mentors. Upon completion, the user receives a real-time diagnosis displayed through interactive bars and charts. This provides greater security and authority on the subject, allowing users to better understand their strengths and areas for improvement.",
